...
<Project Type="Project" LVVersion="17008000">
	...
	<Property Name="varPersistentID:{087C1736-586C-4899-A5C7-A2F14F0B47DE}" Type="Ref">/Target/QCP/Lift.lvlib/Ground_Desired_Height</Property>
	<Property Name="varPersistentID:{10E929CA-A4E8-4AD1-B9DD-3B9F93BC3C61}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Limit</Property>
	<Property Name="varPersistentID:{118B4479-FD3D-46EF-939E-F4F564E1CA76}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Limit</Property>
	<Property Name="varPersistentID:{12122519-D6DA-47DD-B11D-80E19523F2A2}" Type="Ref">/Target/Joystick.lvlib/Axis_3</Property>
	<Property Name="varPersistentID:{12B3F8FF-537F-4976-A0A0-9DA811C4BE7B}" Type="Ref">/Target/QCP/Lift.lvlib/Lift_Tolerance_Tuning</Property>
	...
	<Property Name="varPersistentID:{18280868-F671-47FE-AAF3-7D4F07E4AD97}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Distance_Holding_Still_PID_Gains_Tuning</Property>
	...
	<Property Name="varPersistentID:{1B789DEA-5848-4766-9CC3-FA921207FB16}" Type="Ref">/Target/QCP/Lift.lvlib/To_Switch_Desired_Height</Property>
	<Property Name="varPersistentID:{1B9A55A9-4D65-4951-8410-7A900FBF814B}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Low_Desired_Height_Tuning</Property>
	<Property Name="varPersistentID:{1BFAE0A3-25BC-49BD-A801-C19011076A6E}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Medium_Desired_Height</Property>
	<Property Name="varPersistentID:{1C142F3A-A314-4B5C-8718-72511994468B}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Lift_Power_Tuning</Property>
	<Property Name="varPersistentID:{1DB81B0B-8ED6-4435-8567-2D8DA7BAE77B}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Speed_Near_Limit</Property>
	...
	<Property Name="varPersistentID:{21684ECF-5BD1-456A-A1D9-6D53D7200135}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Speed_Near_Limit</Property>
	<Property Name="varPersistentID:{2404CAB7-E0B7-4E84-A9B5-023D38A66AEC}" Type="Ref">/Target/DevRefs.lvlib/DriveNotifiers</Property>
	<Property Name="varPersistentID:{2459B91A-3CB7-4785-AFC0-3DE9BAAAC68D}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Tolerance</Property>
	<Property Name="varPersistentID:{2C0FDB7E-61D5-4CFA-AE4F-03D601E6A1FE}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Distance_Holding_Still_PID_Gains</Property>
	...
	<Property Name="varPersistentID:{2F26AC33-B377-4194-9DA3-842D4E8FFE5C}" Type="Ref">/Target/QCP/Lift.lvlib/To_Switch_Desired_Height_Tuning</Property>
	<Property Name="varPersistentID:{30FD2D8A-DD05-4C3E-BD21-31DD7038F436}" Type="Ref">/Target/QCP/Lift.lvlib/Ground_Desired_Rotation_Tuning</Property>
	<Property Name="varPersistentID:{33581120-9503-4399-816A-12390958FF70}" Type="Ref">/Target/DevRefs.lvlib/ClimbNotifiers</Property>
	<Property Name="varPersistentID:{33C43A6A-0F36-4082-B8FE-AD2B9FBB24AE}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_High_Desired_Rotation</Property>
	...
	<Property Name="varPersistentID:{34CA690E-B23D-4C69-86B5-8900B19E279F}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_High_Desired_Height</Property>
	<Property Name="varPersistentID:{36F2A09D-19F6-447A-A863-C7C9EA40EA25}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Medium_Desired_Rotation</Property>
	...
	<Property Name="varPersistentID:{3A402BD1-B332-4381-B64C-227B6558C3D8}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Limit_Tuning</Property>
	...
	<Property Name="varPersistentID:{3B736AB1-F71F-47E2-A25C-8582989BEC10}" Type="Ref">/Target/QCP/Lift.lvlib/To_Switch_Desired_Rotation</Property>
	<Property Name="varPersistentID:{426E2F49-8B4F-4956-8D0B-BAF93EC8B408}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Near_Limit</Property>
	<Property Name="varPersistentID:{43C179BA-C908-4457-B1E2-F9F2244F170C}" Type="Ref">/Target/QCP/Climb.lvlib/Climb_Motor_Power_Tuning</Property>
	<Property Name="varPersistentID:{452B8E69-1788-47DB-82F2-E71F6EA9616E}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Limit</Property>
	<Property Name="varPersistentID:{4560A73C-E2A4-4E48-AEF6-BF34415B787F}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Medium_Desired_Height_Tuning</Property>
	<Property Name="varPersistentID:{45A7C1F1-8567-4830-B53E-54AFE5D1F8A7}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Manual_Motor_Power</Property>
	...
	<Property Name="varPersistentID:{486C502E-D330-4911-9768-F6650467DDD2}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Limit_Tuning</Property>
	<Property Name="varPersistentID:{49BF13E3-6A3A-4E4B-912A-48C5195154B2}" Type="Ref">/Target/QCP/Climb.lvlib/Climb_Motor_Power</Property>
	<Property Name="varPersistentID:{4C1B94C6-DB0C-4042-8D71-D32D2598DA71}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Low_Desired_Rotation_Tuning</Property>
	<Property Name="varPersistentID:{4CBCF554-AE07-46CC-A62A-B06720D48CF4}" Type="Ref">/Target/QCP/Lift.lvlib/Lift_Tolerance</Property>
	...
	<Property Name="varPersistentID:{4D4835EE-436B-4888-9F7F-3703A8CF4218}" Type="Ref">/Target/QCP/Lift.lvlib/To_Switch_Desired_Rotation_Tuning</Property>
	<Property Name="varPersistentID:{4E079D30-0176-4E95-8967-AAE44CE54900}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Free_High_Limit</Property>
	<Property Name="varPersistentID:{507B7024-F342-4B58-9F4A-F83850A3C76D}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Yaw_Holding_Still_PID_Gains_Tuning</Property>
	<Property Name="varPersistentID:{521D67CA-6353-4754-9FD1-68A3690F6724}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Yaw_Driving_Straight_PID_Gains</Property>
	...
	<Property Name="varPersistentID:{575F7EE3-EF32-4245-B7B1-3543FD668D52}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Speed_Near_Limit</Property>
	...
	<Property Name="varPersistentID:{59D0D1D5-4043-4FB7-9452-336F0B4E4F3A}" Type="Ref">/Target/QCP/SensorLoop.lvlib/Lift_Rotation_Scale</Property>
	<Property Name="varPersistentID:{5DE8D941-53EF-4C8F-9D01-19E4899A1421}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Speed_Near_Limit</Property>
	<Property Name="varPersistentID:{60E196A2-06BD-4AAA-BBA3-1C2A86E9F382}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Speed_Near_Limit_Tuning</Property>
	...
	<Property Name="varPersistentID:{712A7080-545B-4BF9-ABA4-F69C473F79FF}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Lift_Power</Property>
	...
	<Property Name="varPersistentID:{7637C963-A67D-4869-86F4-A8DF948E8E45}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Manual_Motor_Power</Property>
	<Property Name="varPersistentID:{775DEF1B-B841-4F22-98B0-6BC635FC9B93}" Type="Ref">/Target/QCP/Lift.lvlib/Free_Rotate_Height</Property>
	<Property Name="varPersistentID:{7C35AE90-4A91-483A-9CCD-0529A6A0BCA1}" Type="Ref">/Target/Joystick.lvlib/Axis_2</Property>
	<Property Name="varPersistentID:{7C385CEF-60A5-4ABD-9364-7C9207D821C0}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Distance_Driving_PID_Gains_Tuning</Property>
	<Property Name="varPersistentID:{7D6E1321-A39C-4FF8-84AA-414B7CFBDE2D}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Speed_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{819AB033-294D-409E-9661-0ABE260A1947}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Speed_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{81DA3A58-83B9-42E9-AC43-1A4918523C4F}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Limit_Tuning</Property>
	<Property Name="varPersistentID:{872AD265-AA4C-45B5-B165-24E966EA69A6}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_High_Desired_Height_Tuning</Property>
	...
	<Property Name="varPersistentID:{8D05A445-C58A-45E2-AFB2-2A7A74DDF7C0}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Medium_Desired_Rotation_Tuning</Property>
	...
	<Property Name="varPersistentID:{8D8D3528-2574-4026-9FD2-2DC910F02204}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Low_Desired_Height</Property>
	<Property Name="varPersistentID:{8D9615AA-2C81-4FB7-99F3-17C77A8B6F6F}" Type="Ref">/Target/QCP/SensorLoop.lvlib/Lift_Rotation_Scale_Tuning</Property>
	<Property Name="varPersistentID:{8FE6720B-24E5-47C7-92FA-30AFDC235F5F}" Type="Ref">/Target/QCP/Climb.lvlib/Climb_Deploy_Angle_Tuning</Property>
	...
	<Property Name="varPersistentID:{910F7005-57A1-459F-942C-6A106BA54B82}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Tolerance_Tuning</Property>
	<Property Name="varPersistentID:{9120F907-1BE6-4F53-B697-0418C6430743}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Near_Limit_Tuning</Property>
	...
	<Property Name="varPersistentID:{9A697755-7DA9-4C96-A3A2-0AA8A52C0023}" Type="Ref">/Target/QCP/Intake.lvlib/Intake_Motor_Power_Tuning</Property>
	<Property Name="varPersistentID:{9BF8C57F-F295-4AA6-A6B5-2C35A15EC50B}" Type="Ref">/Target/QCP/Lift.lvlib/Ground_Desired_Height_Tuning</Property>
	<Property Name="varPersistentID:{A05945ED-E054-41FE-8924-BC208FE18362}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Free_High_Limit_Tuning</Property>
	<Property Name="varPersistentID:{A1269A7D-6792-4F5F-B14A-D47D42BE493C}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Near_Limit</Property>
	<Property Name="varPersistentID:{A1AF9F26-6DB4-431E-A7A7-41FF850F7F78}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Speed_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{A1B034E2-4352-4421-A19F-8F8782096253}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Yaw_Driving_Straight_PID_Gains_Tuning</Property>
	<Property Name="varPersistentID:{A2F69A1B-CAE2-4411-A704-847AF1BAE1CF}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Lift_Power</Property>
	...
	<Property Name="varPersistentID:{AFDEC2BB-B593-41ED-853E-9FF905F9E1B4}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Lift_Power_Tuning</Property>
	<Property Name="varPersistentID:{B23E835B-CEE1-466E-A956-E1935A701B8D}" Type="Ref">/Target/QCP/SensorLoop.lvlib/Lift_Elevation_Scale_Tuning</Property>
	<Property Name="varPersistentID:{B33E1B4F-BE12-4A7D-BF75-11CCCEC3C050}" Type="Ref">/Target/QCP/Lift.lvlib/Free_Rotate_Height_Tuning</Property>
	...
	<Property Name="varPersistentID:{B7E5E218-4E41-40C4-9723-33C59EAAD147}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_Low_Desired_Rotation</Property>
	...
	<Property Name="varPersistentID:{BEECF26A-A1BB-4009-A4EC-4AAC4FCEFE28}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_High_Limit</Property>
	<Property Name="varPersistentID:{BF8C2ADF-09D2-4F09-8DD8-911F6143F42D}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Manual_Motor_Power_Tuning</Property>
	<Property Name="varPersistentID:{BFF72EEB-0A4A-4CDA-970C-599A3B316672}" Type="Ref">/Target/QCP/SensorLoop.lvlib/Lift_Elevation_Scale</Property>
	<Property Name="varPersistentID:{C67A3D36-1D8C-4191-A1AB-0E90CA92D204}" Type="Ref">/Target/QCP/Intake.lvlib/Intake_Motor_Power</Property>
	<Property Name="varPersistentID:{C929C38B-73C3-4266-AB9B-3426A05D4033}" Type="Ref">/Target/Joystick.lvlib/Axis_0</Property>
	<Property Name="varPersistentID:{D028308E-E517-4E1C-A26F-E409533C0644}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Manual_Motor_Power_Tuning</Property>
	...
	<Property Name="varPersistentID:{D1AB7D8A-4A88-435B-9482-429EC5972031}" Type="Ref">/Target/QCP/Lift.lvlib/To_Scale_High_Desired_Rotation_Tuning</Property>
	...
	<Property Name="varPersistentID:{D6C4443B-FE26-49DA-86AB-862B3B79E563}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{D7098C23-165B-416C-88BD-F1B2330170C0}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Distance_Driving_PID_Gains</Property>
	<Property Name="varPersistentID:{D97F472A-B04B-4A9E-9055-62CB0B9CC381}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Limit_Tuning</Property>
	<Property Name="varPersistentID:{E052EEE7-2728-4D69-BD42-D5DF43E85761}" Type="Ref">/Target/Joystick.lvlib/Button_RT</Property>
	<Property Name="varPersistentID:{E1F77EE8-E7A0-4C50-936D-828930401E40}" Type="Ref">/Target/QCP/DriveLoop.lvlib/Yaw_Holding_Still_PID_Gains</Property>
	<Property Name="varPersistentID:{E4DC6381-E129-484F-8877-1D47D9DE99F6}" Type="Ref">/Target/QCP/Climb.lvlib/Climb_Deploy_Angle</Property>
	<Property Name="varPersistentID:{E9C7DA0E-A351-484E-8F72-B2D0B2EE2B0F}" Type="Ref">/Target/Joystick.lvlib/Button_RB</Property>
	<Property Name="varPersistentID:{ED297B2C-926A-4AA5-9C35-2BD0B2CCF667}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_High_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{EDA95E39-CC5D-4705-9EF2-2FA239D4B6EE}" Type="Ref">/Target/QCP/Lift.lvlib/Rotational_Low_Near_Limit</Property>
	<Property Name="varPersistentID:{F0A517B7-9AB7-4295-9C45-A8D48257DA7C}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Near_Limit_Tuning</Property>
	<Property Name="varPersistentID:{F32E0BD6-3005-42B0-868E-E00585224BC0}" Type="Ref">/Target/QCP/Lift.lvlib/Vertical_Low_Near_Limit</Property>
	<Property Name="varPersistentID:{F87BB5DE-9237-4230-B77A-E0D89734C490}" Type="Ref">/Target/QCP/Lift.lvlib/Ground_Desired_Rotation</Property>
